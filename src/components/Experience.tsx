...
const experiences = [
  {
    ...
    url: "#",
    highlights: [
      { metric: "5K+", label: "sensor points monitored" },
      { metric: "40%", label: "deployment time saved" },
      { metric: "60%", label: "UI responsiveness gain" },
    ],
    description: [
      "Delivered modern real-time IoT dashboards in React to visualize 5k+ live sensor points and workspace performance, boosting operational visibility for enterprise facility teams.",
      "Designed scalable onboarding and deployment workflows with WebSockets, multistage provisioning, rollback support, and CI/CD improvements to cut time and increase release reliability.",
      "Enabled automated insights and centralized monitoring through intelligent integration of IoT data channels, workflow automation, and cloud-based analytics.",
      "Refined high-volume data rendering and frontend state handling to improve UI responsiveness by 60% for faster, smoother user interactions.",
    ],
    tech: [
      "React",
      "Next.js",
