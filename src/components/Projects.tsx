...
const projects = [
  ...
  {
    title: "Task Manager MSW(Micro Service Worker)",
    subtitle: "Task manager with mocked API testing",
    description:
      "A task management application built with React, TypeScript, Zustand, and React Router. Supports task creation, updates, filtering, and responsive workflows with Mock Service Worker (MSW) for API mocking and Jest + React Testing Library for frontend test coverage.",
    impact: ["Mocked API workflows", "Responsive task UI", "Test coverage"],
    tech: ["React", "TypeScript", "Zustand", "React Router", "MSW", "Jest", "RTL"],
    github: "https://github.com/surajagrawal01/task-manager-msw-ts",
    live: "https://task-manager-msw-ts.vercel.app/dashboard",
    featured: false,
    tag: "Live",
    tagColor: "text-emerald-400 border-emerald-400/30 bg-emerald-400/10",
  },
